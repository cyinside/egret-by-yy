var DataModel = (function () {
    ...
    p.onTouchHandle = function () {
        //var url:string = "http://www.joyoungfeld-ad.com/zhaoyang/game/lookinggame2/resource/assets/share.jpg";
        //DataModel.userInfoArr = [{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url},{"imgurl":url}];
        //DataModel.personNum = 5;
        var url = this.url + "getInfo";
        //var data = {'openid':"od1m6uAqWITdj-REOeIbfqsLJK8E",'game': 3,'datatype':1};
        var data = { 'openid': __global.openID, 'game': 3, 'datatype': 1 };
    ...
    p.onCompleteHandle = function (evt) {
        ...
        if (datacode == 200) {
            ...
            DataModel.personNum = 13255 + datas["result"].total;
            //DataModel.personNum =3255;
    ...
    p.onTouchHandle1 = function () {
        ...
        //var data = {'openid': "asakkkddj",'game': 3,'imgurl':"http://www.joyoungfeld-ad.com/zhaoyang/game/lookinggame2/resource/assets/share.jpg",'name': "huhuhuhuh1",'fuid':DataModel.fuUid,'entranceID':1000,'datatype':1};
        var data = { 'openid': __global.openID, 'game': 3, 'imgurl': __global.headimgurl, 'name': __global.nickname, 'fuid': DataModel.fuUid, 'entranceID': 1000, 'datatype': 1 };
        //var data = {'openid':"asdasdasdasda"+aaa.toString(),'game': 3,'imgurl':"sdasdasdasdasd",'name': "yyyyyyyyy",'fuid':DataModel.fuUid,'entranceID':1000,'datatype':1};
        var jsonstr = JSON.stringify(data);
        jsonstr = this.encryptHandle(jsonstr);
