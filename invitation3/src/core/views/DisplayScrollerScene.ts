class DisplayScrollerScene extends egret.DisplayObjectContainer{
    ...
    public addChildByScrollerAt(child: egret.DisplayObject,num:number): egret.DisplayObject{
        return this.group.addChildAt(child,num);
    }

    public removeChildByScroller(child: egret.DisplayObject): egret.DisplayObject{
