class JSSDK{
    ...
    public static getWeiXinShareTimeline(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",success:Function = null,cancel:Function = null,thisObject:any = null) {
        ...
        if(type == 1) {
            bodyMenuShareTimeline.title = QuestionModel.getInstance().wx_default_title ;
            bodyMenuShareTimeline.link = QuestionModel.getInstance().wx_share_link;
            bodyMenuShareTimeline.imgUrl = QuestionModel.getInstance().wx_share_img;
        }else if(type == 2){
    ...
    public static getWeiXinShareAppMessage(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",desc:string = "",success:Function = null,cancel:Function = null,thisObject:any = null){
        ...
        if(type == 1) {
            bodyMenuShareAppMessage.title = QuestionModel.getInstance().wx_title;
            bodyMenuShareAppMessage.link = QuestionModel.getInstance().wx_share_link;
            bodyMenuShareAppMessage.imgUrl = QuestionModel.getInstance().wx_share_img;
            bodyMenuShareAppMessage.desc = QuestionModel.getInstance().wx_friend_desx;
        }else if(type == 2){
