...
(function (qr) {
    var QRCodeModel = (function () {
        ...
        var d = __define,c=QRCodeModel,p=c.prototype;
        p.addData = function (data) {
            var newData = new qr.QR8bitByte(data);
            this.dataList.push(newData), this.dataCache = null;
        };
        p.isDark = function (row, col) {
        ...
        p.makeImpl = function (test, maskPattern) {
        ...
        p.setupPositionProbePattern = function (row, col) {
            for (var r = -1; r <= 7; r++) {
        ...
        p.createMovieClip = function (target_mc, instance_name, depth) {
        ...
        p.setupTypeNumber = function (test) {
        ...
        p.setupTypeInfo = function (test, maskPattern) {
        ...
        p.mapData = function (data, maskPattern) {
