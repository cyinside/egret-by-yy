 ...
 */
class Sence2 extends DisplayScene {
    public constructor() {
        super();
    ...
    private b3:BitmapDisplay;
    private b4:BitmapDisplay;
    private b5:BitmapDisplay;
    private b6:BitmapDisplay;
    private b7:BitmapDisplay;
    private b8:BitmapDisplay;
    private b9:BitmapDisplay;
    private b10:BitmapDisplay;
    private b11:BitmapDisplay;
    private b12:BitmapDisplay;
    private b13:BitmapDisplay;
    private b14:BitmapDisplay;
    private b15:BitmapDisplay;

    private numTXT:egret.TextField;
    public txtArr:Array<Btninfo> = new Array();
    ...
    private changeCor(evt:egret.TouchEvent){
    ...
    private setResult(evt:egret.TouchEvent){
        var id:number = 0;
        if(evt.currentTarget == this.b1){
            this.b1.alpha = 0;
            id = 1;
        ...
        var btnData:Btninfo = ConfigModel.getInstance().getBtnInfo(id);
        this.txtArr.push(btnData);

        for (var i:number=0;i<this.txtArr.length;i++) {
            if(i > 0){
    ...
    private gotoResultPage(){
        var dataEvent:DataEvent = new DataEvent(DataEvent.GOTO_RESULTPAGE);
