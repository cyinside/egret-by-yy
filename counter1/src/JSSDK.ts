class JSSDK{
    ...
    public static getWeiXinShareTimeline(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",success:Function = null,cancel:Function = null,thisObject:any = null) {
        ...
        if(type == 1) {
            ...
            bodyMenuShareTimeline.link = ConfigModel.getInstance().wx_link/*+ encodeURI(DescriptionModel.userName) +"&colorX="+encodeURI(DescriptionModel.colorPageX.toString())+"&color1X="+encodeURI(DescriptionModel.colorPage1X.toString())*/;
    ...
    public static getWeiXinShareAppMessage(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",desc:string = "",success:Function = null,cancel:Function = null,thisObject:any = null){
        ...
        if(type == 1) {
            ...
            bodyMenuShareAppMessage.link = ConfigModel.getInstance().wx_link/*+ encodeURI(DescriptionModel.userName) +"&colorX="+encodeURI(DescriptionModel.colorPageX.toString())+"&color1X="+encodeURI(DescriptionModel.colorPage1X.toString())*/;
