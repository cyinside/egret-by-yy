...
var LoadingUI = (function (_super) {
    ...
    __egretProto__.tw1 = function () {
        egret.Tween.get(this.rect4, { loop: false }).to({ scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.backIn).call(this.tw2, this).to({ scaleX: 1, scaleY: 1 }, 300, egret.Ease.backIn);
        egret.Tween.get(this.rect4, { loop: false }).to({ alpha: 1 }, 300).to({ alpha: 0.3 }, 300);
    };
    __egretProto__.tw2 = function () {
        egret.Tween.get(this.rect2, { loop: false }).to({ scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.backIn).call(this.tw3, this).to({ scaleX: 1, scaleY: 1 }, 300, egret.Ease.backIn);
        egret.Tween.get(this.rect2, { loop: false }).to({ alpha: 1 }, 300).to({ alpha: 0.3 }, 300);
    };
    __egretProto__.tw3 = function () {
        egret.Tween.get(this.rect1, { loop: false }).to({ scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.backIn).call(this.tw4, this).to({ scaleX: 1, scaleY: 1 }, 300, egret.Ease.backIn);
        egret.Tween.get(this.rect1, { loop: false }).to({ alpha: 1 }, 300).to({ alpha: 0.3 }, 300);
    };
    __egretProto__.tw4 = function () {
        egret.Tween.get(this.rect3, { loop: false }).to({ scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.backIn).call(this.tw5, this).to({ scaleX: 1, scaleY: 1 }, 300, egret.Ease.backIn);
        egret.Tween.get(this.rect3, { loop: false }).to({ alpha: 1 }, 300).to({ alpha: 0.3 }, 300);
    };
    __egretProto__.tw5 = function () {
        egret.Tween.get(this.rect5, { loop: false }).to({ scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.backIn).call(this.tw1, this).to({ scaleX: 1, scaleY: 1 }, 300, egret.Ease.backIn);
        egret.Tween.get(this.rect5, { loop: false }).to({ alpha: 1 }, 300).to({ alpha: 0.3 }, 300);
    };
