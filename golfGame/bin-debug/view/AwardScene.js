...
var AwardScene = (function (_super) {
    ...
    var d = __define,c=AwardScene,p=c.prototype;
    ...
    p.setAward = function () {
        var arrLength = DataModel.awordArr.length;
        if (arrLength != 0) {
            switch (arrLength) {
                case 1:
...
egret.registerClass(AwardScene,'AwardScene');
//# sourceMappingURL=AwardScene.js.map