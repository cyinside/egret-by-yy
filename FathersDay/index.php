...
<head>
	...
	<script egret="lib" src="libs/modules/neoges_lib/neoges_lib.min.js"></script>
	<!--modules_files_end-->
    ...
    <!--game_files_start-->
	<script src="main.min.js?2"></script>
	<!--game_files_end-->
</head>
<body>
<div style="margin: auto;width: 100%;height: 100%;" class="egret-player"
	...
	<audio id="bgmusic" src="resource/assets/bgmusic.mp3" loop="loop" autoplay="autoplay"></audio>
		    <script>
...
<script>
	var base = new Base64();
	function cmdToEncrypt(value)
	{
		return base.encode(value);
	}
	//
	function cmdToDecrypt(value)
	{
