...
<head>
    ...
    <!--game_files_start-->
	<script src="main.min.js?1"></script>
	<!--game_files_end-->
</head>
<body>
...
<audio id="bgmusic1" src="resource/bgmusic.mp3" loop autoplay></audio>
<div id="tongji" style="display: none;"><script src="http://s95.cnzz.com/z_stat.php?id=1255840421&web_id=1255840421" language="JavaScript"></script></div>
    <script>
