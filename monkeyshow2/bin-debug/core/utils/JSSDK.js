var JSSDK = (function () {
    ...
    JSSDK.getWeiXinShareTimeline = function (type, title, link, imgUrl, success, cancel, thisObject) {
        ...
        if (type == 1) {
            bodyMenuShareTimeline.title = "来自" + __global.nickname + ConfigModel.getInstance().wx_title;
    ...
    JSSDK.getWeiXinShareAppMessage = function (type, title, link, imgUrl, desc, success, cancel, thisObject) {
        ...
        if (type == 1) {
            bodyMenuShareAppMessage.title = "来自" + __global.nickname + ConfigModel.getInstance().wx_title;
