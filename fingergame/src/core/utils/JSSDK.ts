class JSSDK{
    ...
    public static getWeiXinShareTimeline(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",success:Function = null,cancel:Function = null,thisObject:any = null) {
        ...
        if(type == 1) {
            bodyMenuShareTimeline.title = ConfigModel.wx_title ;
            bodyMenuShareTimeline.link = ConfigModel.link;
            bodyMenuShareTimeline.imgUrl = ConfigModel.imgURL;
        }else if(type == 2){
    ...
    public static getWeiXinShareAppMessage(type:number = 1,title:string = "",link:string = "",imgUrl:string = "",desc:string = "",success:Function = null,cancel:Function = null,thisObject:any = null){
        ...
        if(type == 1) {
            bodyMenuShareAppMessage.title = ConfigModel.wx_title ;
            bodyMenuShareAppMessage.link = ConfigModel.link;
            bodyMenuShareAppMessage.imgUrl = ConfigModel.imgURL;
            bodyMenuShareAppMessage.desc = ConfigModel.getUserName()+ConfigModel.wx_desc;
        }else if(type == 2){
