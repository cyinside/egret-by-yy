 ...
 */
    var calendar = {
        ...
        /**
         * 浼犲叆鍏巻骞存湀鏃ヨ幏寰楄缁嗙殑鍏巻銆佸啘鍘唎bject淇℃伅 <=>JSON
         * @param y  solar year
         * @param m solar month
         * @param d  solar day
         * @return JSON object
        ...
        solar2lunar: function (y, m, d) { //鍙傛暟鍖洪棿1900.1.31~2100.12.31
            ...
            //澶╁共鍦版敮澶勭悊
            var sm = m - 1;
            var term3 = calendar.getTerm(year, 3); //璇ュ啘鍘嗗勾绔嬫槬鏃ユ湡
            var gzY = calendar.toGanZhi(year - 4);//鏅�氭寜骞翠唤璁＄畻锛屼笅鏂瑰皻闇�鎸夌珛鏄ヨ妭姘旀潵淇
        ...
        /**
         * 浼犲叆鍏巻骞存湀鏃ヤ互鍙婁紶鍏ョ殑鏈堜唤鏄惁闂版湀鑾峰緱璇︾粏鐨勫叕鍘嗐�佸啘鍘唎bject淇℃伅 <=>JSON
         * @param y  lunar year
         * @param m lunar month
         * @param d  lunar day
