...
<div id="userImg"></div>
    ...
    <script src="cnDay.js" type="text/javascript"></script>
    <script type="text/javascript">
    	function onListenHandle(callback){
    		var myDate = new Date();
    		var lunar = calendar.solar2lunar(myDate.getFullYear(),myDate.getMonth()+1,myDate.getDate());
    		callback(lunar.IMonthCn,lunar.IDayCn,lunar.gzYear,lunar.gzMonth,lunar.gzDay,lunar.Animal);
    	}
    </script>
</body>
</html>
