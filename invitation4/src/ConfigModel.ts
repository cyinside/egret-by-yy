class ConfigModel{
    ...
    public uNameTxt:string = __global.nickname.toString();
    //public uNameTxt:string = "cyy1";
    public uNameTxt1:string = "";
    public headUrl:string = __global.headimgurl.toString();
    public headUrl1:string = "http://www.joyoungfeld-ad.com/zhaoyang/game/lookinggame2/resource/assets/share.jpg";
    ...
    public updateShare():void{
        var link:string = this.wx_share_link
            ...
            + "&end";
        var utitle:string = ConfigModel.getInstance().uNameTxt;
